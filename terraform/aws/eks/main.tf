...
##  License: MIT
##  Date: Summer 2025
##  Description: Infrastructure as Code for EKS with Calico CNI, Cert-Manager,
...
##  License: MIT
##  Date: Summer 2025
##  Description: Core EKS cluster infrastructure.
## -------------------------------------------------------------------------------------------
################################################################################
...
locals {
  ...
  base_cpu_pool = {
    cpu_pool = {
      ...
      instance_types = ["t3.xlarge"] # t3.medium (2 vCPU, 4 GiB RAM), 
  ...
  gpu_pool = {
    gpu_pool = {
      ...
      instance_types = ["g4dn.xlarge"]        # NVIDIA T4 (16 GiB GPU mem)
...
module "eks" {
  ...
  # Don't create the CloudWatch log group  
  # create_cloudwatch_log_group = false
